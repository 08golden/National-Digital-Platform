...
export async function PATCH(
  ...
  // Collections can be edited by creator or admin
  ...
  if (readErr || !current) {
    ...
    return Response.json({ error: readErr?.message ?? 'Collection not found' }, { status: 500 })
  }
  ...
  return Response.json({
    message: 'Metadata updated on collections',
    table: 'collections',
    id: updated.id,
