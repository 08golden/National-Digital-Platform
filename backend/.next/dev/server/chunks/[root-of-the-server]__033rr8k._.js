...
"[project]/OneDrive - NUST/Documents/GitHub/Digital-Language-Repository/backend/src/app/api/recordings/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
async function GET() {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive__$2d$__NUST$2f$Documents$2f$GitHub$2f$Digital$2d$Language$2d$Repository$2f$backend$2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('recordings').select('*').eq('status', 'published');
    if (error) {
...
async function POST(request) {
    try {
        ...
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive__$2d$__NUST$2f$Documents$2f$GitHub$2f$Digital$2d$Language$2d$Repository$2f$backend$2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('recordings').insert({
            title,
            description,
            language_id,
            status: 'pending'
...
//# sourceMappingURL=%5Broot-of-the-server%5D__033rr8k._.js.map